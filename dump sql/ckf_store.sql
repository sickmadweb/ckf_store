...
--
-- Хост: localhost
-- Время создания: Дек 20 2020 г., 11:49
...
--
-- База данных: `ckf_store`
--

-- --------------------------------------------------------

--
-- Структура таблицы `ckf_address`
--

CREATE TABLE `ckf_address` (
...
--
-- Структура таблицы `ckf_api`
--

CREATE TABLE `ckf_api` (
...
--
-- Дамп данных таблицы `ckf_api`
--

INSERT INTO `ckf_api` (`api_id`, `username`, `key`, `status`, `date_added`, `date_modified`) VALUES
(1, 'Default', '', 1, '2020-12-20 17:47:04', '2020-12-20 17:47:04');

-- --------------------------------------------------------

--
-- Структура таблицы `ckf_api_ip`
--

CREATE TABLE `ckf_api_ip` (
...
--
-- Структура таблицы `ckf_api_session`
--

CREATE TABLE `ckf_api_session` (
...
--
-- Структура таблицы `ckf_article`
--

CREATE TABLE `ckf_article` (
...
--
-- Дамп данных таблицы `ckf_article`
--

INSERT INTO `ckf_article` (`article_id`, `image`, `date_available`, `sort_order`, `article_review`, `status`, `noindex`, `date_added`, `date_modified`, `viewed`, `gstatus`) VALUES
...
--
-- Структура таблицы `ckf_article_description`
--

CREATE TABLE `ckf_article_description` (
  `article_id` int(11) NOT NULL,
...
--
-- Дамп данных таблицы `ckf_article_description`
--

INSERT INTO `ckf_article_description` (`article_id`, `language_id`, `name`, `description`, `meta_description`, `meta_keyword`, `meta_title`, `meta_h1`, `tag`) VALUES
...
--
-- Структура таблицы `ckf_article_image`
--

CREATE TABLE `ckf_article_image` (
...
--
-- Структура таблицы `ckf_article_related`
--

CREATE TABLE `ckf_article_related` (
  `article_id` int(11) NOT NULL,
  `related_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Дамп данных таблицы `ckf_article_related`
--

INSERT INTO `ckf_article_related` (`article_id`, `related_id`) VALUES
(120, 123),
(120, 124),
(123, 120),
(123, 124),
...
--
-- Структура таблицы `ckf_article_related_mn`
--

CREATE TABLE `ckf_article_related_mn` (
  `article_id` int(11) NOT NULL,
  `manufacturer_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Дамп данных таблицы `ckf_article_related_mn`
--

INSERT INTO `ckf_article_related_mn` (`article_id`, `manufacturer_id`) VALUES
(120, 8),
(120, 9),
(123, 8),
(124, 7);
...
--
-- Структура таблицы `ckf_article_related_product`
--

CREATE TABLE `ckf_article_related_product` (
  `article_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Дамп данных таблицы `ckf_article_related_product`
--

INSERT INTO `ckf_article_related_product` (`article_id`, `product_id`) VALUES
(30, 123),
(31, 123),
(43, 123),
(45, 123),
...
--
-- Структура таблицы `ckf_article_related_wb`
--

CREATE TABLE `ckf_article_related_wb` (
  `article_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Дамп данных таблицы `ckf_article_related_wb`
--

INSERT INTO `ckf_article_related_wb` (`article_id`, `category_id`) VALUES
(120, 26),
(123, 20),
(124, 18),
(125, 18),
...
--
-- Структура таблицы `ckf_article_to_blog_category`
--

CREATE TABLE `ckf_article_to_blog_category` (
  `article_id` int(11) NOT NULL,
...
--
-- Дамп данных таблицы `ckf_article_to_blog_category`
--

INSERT INTO `ckf_article_to_blog_category` (`article_id`, `blog_category_id`, `main_blog_category`) VALUES
(124, 0, 0),
(123, 70, 1),
(120, 0, 0),
(125, 69, 1),
...
--
-- Структура таблицы `ckf_article_to_download`
--

CREATE TABLE `ckf_article_to_download` (
  `article_id` int(11) NOT NULL,
...
--
-- Структура таблицы `ckf_article_to_layout`
--

CREATE TABLE `ckf_article_to_layout` (
  `article_id` int(11) NOT NULL,
...
--
-- Дамп данных таблицы `ckf_article_to_layout`
--

INSERT INTO `ckf_article_to_layout` (`article_id`, `store_id`, `layout_id`) VALUES
(120, 0, 0),
(123, 0, 0),
(124, 0, 0),
(125, 0, 0);
...
--
-- Структура таблицы `ckf_article_to_store`
--

CREATE TABLE `ckf_article_to_store` (
  `article_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL DEFAULT 0
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Дамп данных таблицы `ckf_article_to_store`
--

INSERT INTO `ckf_article_to_store` (`article_id`, `store_id`) VALUES
(120, 0),
(123, 0),
(124, 0),
(125, 0);
...
--
-- Структура таблицы `ckf_attribute`
--

CREATE TABLE `ckf_attribute` (
...
--
-- Дамп данных таблицы `ckf_attribute`
--

INSERT INTO `ckf_attribute` (`attribute_id`, `attribute_group_id`, `sort_order`) VALUES
(1, 6, 1),
(2, 6, 5),
(3, 6, 3),
(4, 3, 1),
...
--
-- Структура таблицы `ckf_attribute_description`
--

CREATE TABLE `ckf_attribute_description` (
  `attribute_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
...
--
-- Дамп данных таблицы `ckf_attribute_description`
--

INSERT INTO `ckf_attribute_description` (`attribute_id`, `language_id`, `name`) VALUES
(1, 1, 'Description'),
(2, 1, 'No. of Cores'),
(4, 1, 'test 1'),
(5, 1, 'test 2'),
...
--
-- Структура таблицы `ckf_attribute_group`
--

CREATE TABLE `ckf_attribute_group` (
  `attribute_group_id` int(11) NOT NULL,
  `sort_order` int(3) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Дамп данных таблицы `ckf_attribute_group`
--

INSERT INTO `ckf_attribute_group` (`attribute_group_id`, `sort_order`) VALUES
(3, 2),
(4, 1),
(5, 3),
(6, 4);
...
--
-- Структура таблицы `ckf_attribute_group_description`
--

CREATE TABLE `ckf_attribute_group_description` (
  `attribute_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Дамп данных таблицы `ckf_attribute_group_description`
--

INSERT INTO `ckf_attribute_group_description` (`attribute_group_id`, `language_id`, `name`) VALUES
(3, 1, 'Memory'),
(4, 1, 'Technical'),
(5, 1, 'Motherboard'),
(6, 1, 'Processor'),
...
--
-- Структура таблицы `ckf_banner`
--

CREATE TABLE `ckf_banner` (
...
--
-- Дамп данных таблицы `ckf_banner`
--

INSERT INTO `ckf_banner` (`banner_id`, `name`, `status`) VALUES
(6, 'HP Products', 1),
...
--
-- Структура таблицы `ckf_banner_image`
--

CREATE TABLE `ckf_banner_image` (
...
--
-- Дамп данных таблицы `ckf_banner_image`
--

INSERT INTO `ckf_banner_image` (`banner_image_id`, `banner_id`, `language_id`, `title`, `link`, `image`, `sort_order`) VALUES
...
--
-- Структура таблицы `ckf_blog_category`
--

CREATE TABLE `ckf_blog_category` (
  `blog_category_id` int(11) NOT NULL,
  `image` varchar(255) DEFAULT NULL,
...
--
-- Дамп данных таблицы `ckf_blog_category`
--

INSERT INTO `ckf_blog_category` (`blog_category_id`, `image`, `parent_id`, `top`, `column`, `sort_order`, `status`, `noindex`, `date_added`, `date_modified`) VALUES
...
--
-- Структура таблицы `ckf_blog_category_description`
--

CREATE TABLE `ckf_blog_category_description` (
  `blog_category_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
...
--
-- Дамп данных таблицы `ckf_blog_category_description`
--

INSERT INTO `ckf_blog_category_description` (`blog_category_id`, `language_id`, `name`, `description`, `meta_description`, `meta_keyword`, `meta_title`, `meta_h1`) VALUES
(69, 2, 'News', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', '', '', '', ''),
(70, 1, 'Обзоры', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', '', '', '', ''),
(69, 1, 'Новости', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', '', '', '', ''),
(71, 2, 'Анонсы', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', '', '', '', ''),
...
--
-- Структура таблицы `ckf_blog_category_path`
--

CREATE TABLE `ckf_blog_category_path` (
  `blog_category_id` int(11) NOT NULL,
...
--
-- Дамп данных таблицы `ckf_blog_category_path`
--

INSERT INTO `ckf_blog_category_path` (`blog_category_id`, `path_id`, `level`) VALUES
(69, 69, 0),
(71, 71, 1),
(71, 69, 0),
(70, 70, 0);
...
--
-- Структура таблицы `ckf_blog_category_to_layout`
--

CREATE TABLE `ckf_blog_category_to_layout` (
  `blog_category_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Дамп данных таблицы `ckf_blog_category_to_layout`
--

INSERT INTO `ckf_blog_category_to_layout` (`blog_category_id`, `store_id`, `layout_id`) VALUES
(69, 0, 0),
(71, 0, 0),
(70, 0, 0);
...
--
-- Структура таблицы `ckf_blog_category_to_store`
--

CREATE TABLE `ckf_blog_category_to_store` (
  `blog_category_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Дамп данных таблицы `ckf_blog_category_to_store`
--

INSERT INTO `ckf_blog_category_to_store` (`blog_category_id`, `store_id`) VALUES
(69, 0),
(70, 0),
(71, 0);
...
--
-- Структура таблицы `ckf_cart`
--

CREATE TABLE `ckf_cart` (
...
--
-- Структура таблицы `ckf_category`
--

CREATE TABLE `ckf_category` (
  `category_id` int(11) NOT NULL,
  `image` varchar(255) DEFAULT NULL,
  `parent_id` int(11) NOT NULL DEFAULT 0,
  `top` tinyint(1) NOT NULL,
...
--
-- Дамп данных таблицы `ckf_category`
--

INSERT INTO `ckf_category` (`category_id`, `image`, `parent_id`, `top`, `column`, `sort_order`, `status`, `date_added`, `date_modified`, `noindex`) VALUES
...
--
-- Структура таблицы `ckf_category_description`
--

CREATE TABLE `ckf_category_description` (
  `category_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
  `description` text NOT NULL,
...
--
-- Дамп данных таблицы `ckf_category_description`
--

INSERT INTO `ckf_category_description` (`category_id`, `language_id`, `name`, `description`, `meta_title`, `meta_description`, `meta_keyword`, `meta_h1`) VALUES
(28, 1, 'Мониторы', '', '', '', '', ''),
(32, 1, 'Веб-камеры', '', '', '', '', ''),
(31, 1, 'Сканеры', '', '', '', '', ''),
(30, 1, 'Принтеры', '', '', '', '', ''),
...
--
-- Структура таблицы `ckf_category_filter`
--

CREATE TABLE `ckf_category_filter` (
  `category_id` int(11) NOT NULL,
...
--
-- Структура таблицы `ckf_category_path`
--

CREATE TABLE `ckf_category_path` (
  `category_id` int(11) NOT NULL,
  `path_id` int(11) NOT NULL,
  `level` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Дамп данных таблицы `ckf_category_path`
--

INSERT INTO `ckf_category_path` (`category_id`, `path_id`, `level`) VALUES
(25, 25, 0),
(28, 25, 0),
(28, 28, 1),
(35, 25, 0),
...
--
-- Структура таблицы `ckf_category_to_layout`
--

CREATE TABLE `ckf_category_to_layout` (
  `category_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Структура таблицы `ckf_category_to_store`
--

CREATE TABLE `ckf_category_to_store` (
  `category_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Дамп данных таблицы `ckf_category_to_store`
--

INSERT INTO `ckf_category_to_store` (`category_id`, `store_id`) VALUES
(17, 0),
(18, 0),
(20, 0),
(24, 0),
...
--
-- Структура таблицы `ckf_country`
--

CREATE TABLE `ckf_country` (
...
--
-- Дамп данных таблицы `ckf_country`
--

INSERT INTO `ckf_country` (`country_id`, `name`, `iso_code_2`, `iso_code_3`, `address_format`, `postcode_required`, `status`) VALUES
...
--
-- Структура таблицы `ckf_coupon`
--

CREATE TABLE `ckf_coupon` (
...
--
-- Дамп данных таблицы `ckf_coupon`
--

INSERT INTO `ckf_coupon` (`coupon_id`, `name`, `code`, `type`, `discount`, `logged`, `shipping`, `total`, `date_start`, `date_end`, `uses_total`, `uses_customer`, `status`, `date_added`) VALUES
...
--
-- Структура таблицы `ckf_coupon_category`
--

CREATE TABLE `ckf_coupon_category` (
  `coupon_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Структура таблицы `ckf_coupon_history`
--

CREATE TABLE `ckf_coupon_history` (
...
--
-- Структура таблицы `ckf_coupon_product`
--

CREATE TABLE `ckf_coupon_product` (
...
--
-- Структура таблицы `ckf_currency`
--

CREATE TABLE `ckf_currency` (
...
--
-- Дамп данных таблицы `ckf_currency`
--

INSERT INTO `ckf_currency` (`currency_id`, `title`, `code`, `symbol_left`, `symbol_right`, `decimal_place`, `value`, `status`, `date_modified`) VALUES
...
--
-- Структура таблицы `ckf_customer`
--

CREATE TABLE `ckf_customer` (
  `customer_id` int(11) NOT NULL,
...
--
-- Структура таблицы `ckf_customer_activity`
--

CREATE TABLE `ckf_customer_activity` (
...
--
-- Структура таблицы `ckf_customer_affiliate`
--

CREATE TABLE `ckf_customer_affiliate` (
  `customer_id` int(11) NOT NULL,
  `company` varchar(40) NOT NULL,
...
--
-- Структура таблицы `ckf_customer_approval`
--

CREATE TABLE `ckf_customer_approval` (
...
--
-- Структура таблицы `ckf_customer_group`
--

CREATE TABLE `ckf_customer_group` (
  `customer_group_id` int(11) NOT NULL,
...
--
-- Дамп данных таблицы `ckf_customer_group`
--

INSERT INTO `ckf_customer_group` (`customer_group_id`, `approval`, `sort_order`) VALUES
(1, 0, 1);

-- --------------------------------------------------------

--
-- Структура таблицы `ckf_customer_group_description`
--

CREATE TABLE `ckf_customer_group_description` (
  `customer_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
...
--
-- Дамп данных таблицы `ckf_customer_group_description`
--

INSERT INTO `ckf_customer_group_description` (`customer_group_id`, `language_id`, `name`, `description`) VALUES
(1, 1, 'Default', 'test');

-- --------------------------------------------------------

--
-- Структура таблицы `ckf_customer_history`
--

CREATE TABLE `ckf_customer_history` (
...
--
-- Структура таблицы `ckf_customer_ip`
--

CREATE TABLE `ckf_customer_ip` (
...
--
-- Структура таблицы `ckf_customer_login`
--

CREATE TABLE `ckf_customer_login` (
...
--
-- Структура таблицы `ckf_customer_online`
--

CREATE TABLE `ckf_customer_online` (
  `ip` varchar(40) NOT NULL,
  `customer_id` int(11) NOT NULL,
  `url` text NOT NULL,
...
--
-- Структура таблицы `ckf_customer_reward`
--

CREATE TABLE `ckf_customer_reward` (
...
--
-- Структура таблицы `ckf_customer_search`
--

CREATE TABLE `ckf_customer_search` (
...
--
-- Структура таблицы `ckf_customer_transaction`
--

CREATE TABLE `ckf_customer_transaction` (
...
--
-- Структура таблицы `ckf_customer_wishlist`
--

CREATE TABLE `ckf_customer_wishlist` (
  `customer_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
  `date_added` datetime NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Структура таблицы `ckf_custom_field`
--

CREATE TABLE `ckf_custom_field` (
...
--
-- Структура таблицы `ckf_custom_field_customer_group`
--

CREATE TABLE `ckf_custom_field_customer_group` (
  `custom_field_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL,
...
--
-- Структура таблицы `ckf_custom_field_description`
--

CREATE TABLE `ckf_custom_field_description` (
  `custom_field_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(128) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Структура таблицы `ckf_custom_field_value`
--

CREATE TABLE `ckf_custom_field_value` (
...
--
-- Структура таблицы `ckf_custom_field_value_description`
--

CREATE TABLE `ckf_custom_field_value_description` (
  `custom_field_value_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `custom_field_id` int(11) NOT NULL,
  `name` varchar(128) NOT NULL
...
--
-- Структура таблицы `ckf_download`
--

CREATE TABLE `ckf_download` (
  `download_id` int(11) NOT NULL,
...
--
-- Структура таблицы `ckf_download_description`
--

CREATE TABLE `ckf_download_description` (
  `download_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Структура таблицы `ckf_event`
--

CREATE TABLE `ckf_event` (
...
--
-- Дамп данных таблицы `ckf_event`
--

INSERT INTO `ckf_event` (`event_id`, `code`, `trigger`, `action`, `status`, `sort_order`) VALUES
...
--
-- Структура таблицы `ckf_extension`
--

CREATE TABLE `ckf_extension` (
...
--
-- Дамп данных таблицы `ckf_extension`
--

INSERT INTO `ckf_extension` (`extension_id`, `type`, `code`) VALUES
(1, 'payment', 'cod'),
(2, 'total', 'shipping'),
(3, 'total', 'sub_total'),
(4, 'total', 'tax'),
...
--
-- Структура таблицы `ckf_extension_install`
--

CREATE TABLE `ckf_extension_install` (
...
--
-- Структура таблицы `ckf_extension_path`
--

CREATE TABLE `ckf_extension_path` (
...
--
-- Структура таблицы `ckf_filter`
--

CREATE TABLE `ckf_filter` (
  `filter_id` int(11) NOT NULL,
...
--
-- Структура таблицы `ckf_filter_description`
--

CREATE TABLE `ckf_filter_description` (
  `filter_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `filter_group_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL
...
--
-- Структура таблицы `ckf_filter_group`
--

CREATE TABLE `ckf_filter_group` (
  `filter_group_id` int(11) NOT NULL,
  `sort_order` int(3) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Структура таблицы `ckf_filter_group_description`
--

CREATE TABLE `ckf_filter_group_description` (
  `filter_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Структура таблицы `ckf_geo_zone`
--

CREATE TABLE `ckf_geo_zone` (
...
--
-- Дамп данных таблицы `ckf_geo_zone`
--

INSERT INTO `ckf_geo_zone` (`geo_zone_id`, `name`, `description`, `date_added`, `date_modified`) VALUES
...
--
-- Структура таблицы `ckf_information`
--

CREATE TABLE `ckf_information` (
...
--
-- Дамп данных таблицы `ckf_information`
--

INSERT INTO `ckf_information` (`information_id`, `bottom`, `sort_order`, `status`, `noindex`) VALUES
(3, 1, 3, 1, 1),
(4, 1, 1, 1, 0),
(5, 1, 4, 1, 1),
(6, 1, 2, 1, 1);
...
--
-- Структура таблицы `ckf_information_description`
--

CREATE TABLE `ckf_information_description` (
  `information_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `title` varchar(64) NOT NULL,
...
--
-- Дамп данных таблицы `ckf_information_description`
--

INSERT INTO `ckf_information_description` (`information_id`, `language_id`, `title`, `description`, `meta_title`, `meta_description`, `meta_keyword`, `meta_h1`) VALUES
...
--
-- Структура таблицы `ckf_information_to_layout`
--

CREATE TABLE `ckf_information_to_layout` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Структура таблицы `ckf_information_to_store`
--

CREATE TABLE `ckf_information_to_store` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Дамп данных таблицы `ckf_information_to_store`
--

INSERT INTO `ckf_information_to_store` (`information_id`, `store_id`) VALUES
(3, 0),
(4, 0),
(5, 0),
(6, 0);
...
--
-- Структура таблицы `ckf_language`
--

CREATE TABLE `ckf_language` (
  `language_id` int(11) NOT NULL,
  `name` varchar(32) NOT NULL,
...
--
-- Дамп данных таблицы `ckf_language`
--

INSERT INTO `ckf_language` (`language_id`, `name`, `code`, `locale`, `image`, `directory`, `sort_order`, `status`) VALUES
...
--
-- Структура таблицы `ckf_layout`
--

CREATE TABLE `ckf_layout` (
  `layout_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Дамп данных таблицы `ckf_layout`
--

INSERT INTO `ckf_layout` (`layout_id`, `name`) VALUES
(1, 'Главная'),
(2, 'Товар'),
(3, 'Категория'),
(4, 'По-умолчанию'),
...
--
-- Структура таблицы `ckf_layout_module`
--

CREATE TABLE `ckf_layout_module` (
...
--
-- Дамп данных таблицы `ckf_layout_module`
--

INSERT INTO `ckf_layout_module` (`layout_module_id`, `layout_id`, `code`, `position`, `sort_order`) VALUES
(2, 4, '0', 'content_top', 0),
(3, 4, '0', 'content_top', 1),
...
--
-- Структура таблицы `ckf_layout_route`
--

CREATE TABLE `ckf_layout_route` (
...
--
-- Дамп данных таблицы `ckf_layout_route`
--

INSERT INTO `ckf_layout_route` (`layout_route_id`, `layout_id`, `store_id`, `route`) VALUES
(38, 6, 0, 'account/%'),
(17, 10, 0, 'affiliate/%'),
...
--
-- Структура таблицы `ckf_length_class`
--

CREATE TABLE `ckf_length_class` (
  `length_class_id` int(11) NOT NULL,
  `value` decimal(15,8) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Дамп данных таблицы `ckf_length_class`
--

INSERT INTO `ckf_length_class` (`length_class_id`, `value`) VALUES
(1, '1.00000000'),
(2, '10.00000000'),
(3, '0.39370000');
...
--
-- Структура таблицы `ckf_length_class_description`
--

CREATE TABLE `ckf_length_class_description` (
  `length_class_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `title` varchar(32) NOT NULL,
...
--
-- Дамп данных таблицы `ckf_length_class_description`
--

INSERT INTO `ckf_length_class_description` (`length_class_id`, `language_id`, `title`, `unit`) VALUES
(1, 1, 'Сантиметр', 'см'),
(1, 2, 'Centimeter', 'cm'),
(2, 1, 'Миллиметр', 'мм'),
(2, 2, 'Millimeter', 'mm'),
...
--
-- Структура таблицы `ckf_location`
--

CREATE TABLE `ckf_location` (
...
--
-- Структура таблицы `ckf_manufacturer`
--

CREATE TABLE `ckf_manufacturer` (
  `manufacturer_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL,
  `image` varchar(255) DEFAULT NULL,
  `sort_order` int(3) NOT NULL,
...
--
-- Дамп данных таблицы `ckf_manufacturer`
--

INSERT INTO `ckf_manufacturer` (`manufacturer_id`, `name`, `image`, `sort_order`, `noindex`) VALUES
...
--
-- Структура таблицы `ckf_manufacturer_description`
--

CREATE TABLE `ckf_manufacturer_description` (
...
--
-- Дамп данных таблицы `ckf_manufacturer_description`
--

INSERT INTO `ckf_manufacturer_description` (`manufacturer_id`, `language_id`, `description`, `description3`, `meta_description`, `meta_keyword`, `meta_title`, `meta_h1`) VALUES
(8, 1, '&lt;br&gt;', '', '', '', '', ''),
(8, 2, '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', '', '', '', '', ''),
(7, 1, '', '', '', '', '', ''),
(7, 2, '', '', '', '', '', ''),
...
--
-- Структура таблицы `ckf_manufacturer_to_layout`
--

CREATE TABLE `ckf_manufacturer_to_layout` (
  `manufacturer_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Структура таблицы `ckf_manufacturer_to_store`
--

CREATE TABLE `ckf_manufacturer_to_store` (
  `manufacturer_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Дамп данных таблицы `ckf_manufacturer_to_store`
--

INSERT INTO `ckf_manufacturer_to_store` (`manufacturer_id`, `store_id`) VALUES
(5, 0),
(6, 0),
(7, 0),
(8, 0),
...
--
-- Структура таблицы `ckf_marketing`
--

CREATE TABLE `ckf_marketing` (
...
--
-- Структура таблицы `ckf_modification`
--

CREATE TABLE `ckf_modification` (
...
--
-- Структура таблицы `ckf_module`
--

CREATE TABLE `ckf_module` (
...
--
-- Дамп данных таблицы `ckf_module`
--

INSERT INTO `ckf_module` (`module_id`, `name`, `code`, `setting`) VALUES
...
--
-- Структура таблицы `ckf_option`
--

CREATE TABLE `ckf_option` (
...
--
-- Дамп данных таблицы `ckf_option`
--

INSERT INTO `ckf_option` (`option_id`, `type`, `sort_order`) VALUES
(1, 'radio', 1),
(2, 'checkbox', 2),
(4, 'text', 3),
(5, 'select', 4),
...
--
-- Структура таблицы `ckf_option_description`
--

CREATE TABLE `ckf_option_description` (
  `option_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(128) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Дамп данных таблицы `ckf_option_description`
--

INSERT INTO `ckf_option_description` (`option_id`, `language_id`, `name`) VALUES
(1, 1, 'Radio'),
(2, 1, 'Checkbox'),
(4, 1, 'Text'),
(6, 1, 'Textarea'),
...
--
-- Структура таблицы `ckf_option_value`
--

CREATE TABLE `ckf_option_value` (
...
--
-- Дамп данных таблицы `ckf_option_value`
--

INSERT INTO `ckf_option_value` (`option_value_id`, `option_id`, `image`, `sort_order`) VALUES
(43, 1, '', 3),
(32, 1, '', 1),
(45, 2, '', 4),
(44, 2, '', 3),
...
--
-- Структура таблицы `ckf_option_value_description`
--

CREATE TABLE `ckf_option_value_description` (
  `option_value_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `option_id` int(11) NOT NULL,
  `name` varchar(128) NOT NULL
...
--
-- Дамп данных таблицы `ckf_option_value_description`
--

INSERT INTO `ckf_option_value_description` (`option_value_id`, `language_id`, `option_id`, `name`) VALUES
(43, 1, 1, 'Large'),
(32, 1, 1, 'Small'),
(45, 1, 2, 'Checkbox 4'),
(44, 1, 2, 'Checkbox 3'),
...
--
-- Структура таблицы `ckf_order`
--

CREATE TABLE `ckf_order` (
  `order_id` int(11) NOT NULL,
...
--
-- Структура таблицы `ckf_order_history`
--

CREATE TABLE `ckf_order_history` (
...
--
-- Структура таблицы `ckf_order_option`
--

CREATE TABLE `ckf_order_option` (
...
--
-- Структура таблицы `ckf_order_product`
--

CREATE TABLE `ckf_order_product` (
  `order_product_id` int(11) NOT NULL,
  `order_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
...
--
-- Структура таблицы `ckf_order_recurring`
--

CREATE TABLE `ckf_order_recurring` (
...
--
-- Структура таблицы `ckf_order_recurring_transaction`
--

CREATE TABLE `ckf_order_recurring_transaction` (
...
--
-- Структура таблицы `ckf_order_shipment`
--

CREATE TABLE `ckf_order_shipment` (
...
--
-- Структура таблицы `ckf_order_status`
--

CREATE TABLE `ckf_order_status` (
  `order_status_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(32) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Дамп данных таблицы `ckf_order_status`
--

INSERT INTO `ckf_order_status` (`order_status_id`, `language_id`, `name`) VALUES
(2, 1, 'В обработке'),
(3, 1, 'Доставлено'),
(7, 1, 'Отменено'),
...
--
-- Структура таблицы `ckf_order_total`
--

CREATE TABLE `ckf_order_total` (
...
--
-- Структура таблицы `ckf_order_voucher`
--

CREATE TABLE `ckf_order_voucher` (
...
--
-- Структура таблицы `ckf_product`
--

CREATE TABLE `ckf_product` (
  `product_id` int(11) NOT NULL,
  `model` varchar(64) NOT NULL,
...
--
-- Структура таблицы `ckf_product_attribute`
--

CREATE TABLE `ckf_product_attribute` (
  `product_id` int(11) NOT NULL,
  `attribute_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `text` text NOT NULL
...
--
-- Дамп данных таблицы `ckf_product_attribute`
--

INSERT INTO `ckf_product_attribute` (`product_id`, `attribute_id`, `language_id`, `text`) VALUES
(43, 2, 1, '1'),
(47, 4, 1, '16GB'),
(43, 4, 1, '8gb'),
(42, 3, 1, '100mhz'),
...
--
-- Структура таблицы `ckf_product_description`
--

CREATE TABLE `ckf_product_description` (
  `product_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
  `description` text NOT NULL,
...
--
-- Дамп данных таблицы `ckf_product_description`
--

INSERT INTO `ckf_product_description` (`product_id`, `language_id`, `name`, `description`, `tag`, `meta_title`, `meta_description`, `meta_keyword`, `meta_h1`) VALUES
...
--
-- Структура таблицы `ckf_product_discount`
--

CREATE TABLE `ckf_product_discount` (
...
--
-- Дамп данных таблицы `ckf_product_discount`
--

INSERT INTO `ckf_product_discount` (`product_discount_id`, `product_id`, `customer_group_id`, `quantity`, `priority`, `price`, `date_start`, `date_end`) VALUES
...
--
-- Структура таблицы `ckf_product_filter`
--

CREATE TABLE `ckf_product_filter` (
  `product_id` int(11) NOT NULL,
  `filter_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Структура таблицы `ckf_product_image`
--

CREATE TABLE `ckf_product_image` (
...
--
-- Дамп данных таблицы `ckf_product_image`
--

INSERT INTO `ckf_product_image` (`product_image_id`, `product_id`, `image`, `sort_order`) VALUES
...
--
-- Структура таблицы `ckf_product_option`
--

CREATE TABLE `ckf_product_option` (
  `product_option_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
  `option_id` int(11) NOT NULL,
  `value` text NOT NULL,
...
--
-- Дамп данных таблицы `ckf_product_option`
--

INSERT INTO `ckf_product_option` (`product_option_id`, `product_id`, `option_id`, `value`, `required`) VALUES
(224, 35, 11, '', 1),
...
--
-- Структура таблицы `ckf_product_option_value`
--

CREATE TABLE `ckf_product_option_value` (
...
--
-- Дамп данных таблицы `ckf_product_option_value`
--

INSERT INTO `ckf_product_option_value` (`product_option_value_id`, `product_option_id`, `product_id`, `option_id`, `option_value_id`, `quantity`, `subtract`, `price`, `price_prefix`, `points`, `points_prefix`, `weight`, `weight_prefix`) VALUES
...
--
-- Структура таблицы `ckf_product_recurring`
--

CREATE TABLE `ckf_product_recurring` (
  `product_id` int(11) NOT NULL,
  `recurring_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Структура таблицы `ckf_product_related`
--

CREATE TABLE `ckf_product_related` (
  `product_id` int(11) NOT NULL,
  `related_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Дамп данных таблицы `ckf_product_related`
--

INSERT INTO `ckf_product_related` (`product_id`, `related_id`) VALUES
(40, 42),
(41, 42),
(42, 40),
(42, 41);
...
--
-- Структура таблицы `ckf_product_related_article`
--

CREATE TABLE `ckf_product_related_article` (
  `article_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Дамп данных таблицы `ckf_product_related_article`
--

INSERT INTO `ckf_product_related_article` (`article_id`, `product_id`) VALUES
(120, 30),
(120, 40),
(120, 42),
(123, 40),
...
--
-- Структура таблицы `ckf_product_related_mn`
--

CREATE TABLE `ckf_product_related_mn` (
  `product_id` int(11) NOT NULL,
  `manufacturer_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Дамп данных таблицы `ckf_product_related_mn`
--

INSERT INTO `ckf_product_related_mn` (`product_id`, `manufacturer_id`) VALUES
(42, 8),
(41, 8),
(30, 9),
(47, 7);
...
--
-- Структура таблицы `ckf_product_related_wb`
--

CREATE TABLE `ckf_product_related_wb` (
  `product_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Дамп данных таблицы `ckf_product_related_wb`
--

INSERT INTO `ckf_product_related_wb` (`product_id`, `category_id`) VALUES
(33, 20),
(41, 26),
(41, 27),
(43, 18),
...
--
-- Структура таблицы `ckf_product_reward`
--

CREATE TABLE `ckf_product_reward` (
...
--
-- Дамп данных таблицы `ckf_product_reward`
--

INSERT INTO `ckf_product_reward` (`product_reward_id`, `product_id`, `customer_group_id`, `points`) VALUES
(515, 42, 1, 100),
(519, 47, 1, 300),
(379, 28, 1, 400),
(329, 43, 1, 600),
...
--
-- Структура таблицы `ckf_product_special`
--

CREATE TABLE `ckf_product_special` (
...
--
-- Дамп данных таблицы `ckf_product_special`
--

INSERT INTO `ckf_product_special` (`product_special_id`, `product_id`, `customer_group_id`, `priority`, `price`, `date_start`, `date_end`) VALUES
...
--
-- Структура таблицы `ckf_product_to_category`
--

CREATE TABLE `ckf_product_to_category` (
  `product_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL,
...
--
-- Дамп данных таблицы `ckf_product_to_category`
--

INSERT INTO `ckf_product_to_category` (`product_id`, `category_id`, `main_category`) VALUES
(28, 24, 1),
(28, 20, 0),
(29, 24, 1),
(29, 20, 0),
...
--
-- Структура таблицы `ckf_product_to_download`
--

CREATE TABLE `ckf_product_to_download` (
  `product_id` int(11) NOT NULL,
  `download_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Структура таблицы `ckf_product_to_layout`
--

CREATE TABLE `ckf_product_to_layout` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Структура таблицы `ckf_product_to_store`
--

CREATE TABLE `ckf_product_to_store` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL DEFAULT 0
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Дамп данных таблицы `ckf_product_to_store`
--

INSERT INTO `ckf_product_to_store` (`product_id`, `store_id`) VALUES
(28, 0),
(29, 0),
(30, 0),
(31, 0),
...
--
-- Структура таблицы `ckf_recurring`
--

CREATE TABLE `ckf_recurring` (
  `recurring_id` int(11) NOT NULL,
...
--
-- Структура таблицы `ckf_recurring_description`
--

CREATE TABLE `ckf_recurring_description` (
  `recurring_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Структура таблицы `ckf_return`
--

CREATE TABLE `ckf_return` (
...
--
-- Структура таблицы `ckf_return_action`
--

CREATE TABLE `ckf_return_action` (
  `return_action_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL DEFAULT 0,
  `name` varchar(64) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Дамп данных таблицы `ckf_return_action`
--

INSERT INTO `ckf_return_action` (`return_action_id`, `language_id`, `name`) VALUES
(1, 1, 'Возмещенный'),
(2, 1, 'Возврат средств'),
...
--
-- Структура таблицы `ckf_return_history`
--

CREATE TABLE `ckf_return_history` (
...
--
-- Структура таблицы `ckf_return_reason`
--

CREATE TABLE `ckf_return_reason` (
  `return_reason_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL DEFAULT 0,
  `name` varchar(128) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Дамп данных таблицы `ckf_return_reason`
--

INSERT INTO `ckf_return_reason` (`return_reason_id`, `language_id`, `name`) VALUES
...
--
-- Структура таблицы `ckf_return_status`
--

CREATE TABLE `ckf_return_status` (
  `return_status_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL DEFAULT 0,
  `name` varchar(32) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Дамп данных таблицы `ckf_return_status`
--

INSERT INTO `ckf_return_status` (`return_status_id`, `language_id`, `name`) VALUES
(1, 1, 'В ожидании'),
(3, 1, 'Выполнен'),
(2, 1, 'Ожидание товара'),
(1, 2, 'Pending'),
...
--
-- Структура таблицы `ckf_review`
--

CREATE TABLE `ckf_review` (
...
--
-- Структура таблицы `ckf_review_article`
--

CREATE TABLE `ckf_review_article` (
...
--
-- Дамп данных таблицы `ckf_review_article`
--

INSERT INTO `ckf_review_article` (`review_article_id`, `article_id`, `customer_id`, `author`, `text`, `rating`, `status`, `date_added`, `date_modified`) VALUES
...
--
-- Структура таблицы `ckf_seo_url`
--

CREATE TABLE `ckf_seo_url` (
...
--
-- Дамп данных таблицы `ckf_seo_url`
--

INSERT INTO `ckf_seo_url` (`seo_url_id`, `store_id`, `language_id`, `query`, `keyword`) VALUES
...
--
-- Структура таблицы `ckf_session`
--

CREATE TABLE `ckf_session` (
  `session_id` varchar(32) NOT NULL,
  `data` text NOT NULL,
...
--
-- Дамп данных таблицы `ckf_session`
--

INSERT INTO `ckf_session` (`session_id`, `data`, `expire`) VALUES
('1d45341cc00b3474a7401d271f', '{\"language\":\"ru-ru\",\"currency\":\"RUB\"}', '2020-12-20 11:11:08');

-- --------------------------------------------------------

--
-- Структура таблицы `ckf_setting`
--

CREATE TABLE `ckf_setting` (
...
--
-- Дамп данных таблицы `ckf_setting`
--

INSERT INTO `ckf_setting` (`setting_id`, `store_id`, `code`, `key`, `value`, `serialized`) VALUES
...
(13, 0, 'config', 'config_meta_title', 'Ваш магазин', 0),
...
(19, 0, 'config', 'config_zone_id', '2761', 0),
...
(59, 0, 'config', 'config_logo', 'catalog/opencart-logo.png', 0),
...
(224, 0, 'config', 'config_email', 'sickmadweb@gmail.com', 0),
(67, 0, 'config', 'config_geocode', '', 0),
(68, 0, 'config', 'config_owner', 'Ваш магазин', 0),
(69, 0, 'config', 'config_address', 'Адрес', 0),
(70, 0, 'config', 'config_name', 'Ваш магазин', 0),
...
(225, 0, 'config', 'config_encryption', '', 0),
...
--
-- Структура таблицы `ckf_shipping_courier`
--

CREATE TABLE `ckf_shipping_courier` (
...
--
-- Дамп данных таблицы `ckf_shipping_courier`
--

INSERT INTO `ckf_shipping_courier` (`shipping_courier_id`, `shipping_courier_code`, `shipping_courier_name`) VALUES
(1, 'dhl', 'DHL'),
(2, 'fedex', 'Fedex'),
(3, 'ups', 'UPS'),
...
--
-- Структура таблицы `ckf_statistics`
--

CREATE TABLE `ckf_statistics` (
...
--
-- Дамп данных таблицы `ckf_statistics`
--

INSERT INTO `ckf_statistics` (`statistics_id`, `code`, `value`) VALUES
(1, 'order_sale', '0.0000'),
...
--
-- Структура таблицы `ckf_stock_status`
--

CREATE TABLE `ckf_stock_status` (
  `stock_status_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(32) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Дамп данных таблицы `ckf_stock_status`
--

INSERT INTO `ckf_stock_status` (`stock_status_id`, `language_id`, `name`) VALUES
(7, 1, 'В наличии'),
(8, 1, 'Предзаказ'),
(5, 1, 'Нет в наличии'),
...
--
-- Структура таблицы `ckf_store`
--

CREATE TABLE `ckf_store` (
  `store_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL,
...
--
-- Структура таблицы `ckf_tax_class`
--

CREATE TABLE `ckf_tax_class` (
  `tax_class_id` int(11) NOT NULL,
  `title` varchar(32) NOT NULL,
  `description` varchar(255) NOT NULL,
  `date_added` datetime NOT NULL,
...
--
-- Дамп данных таблицы `ckf_tax_class`
--

INSERT INTO `ckf_tax_class` (`tax_class_id`, `title`, `description`, `date_added`, `date_modified`) VALUES
...
--
-- Структура таблицы `ckf_tax_rate`
--

CREATE TABLE `ckf_tax_rate` (
...
--
-- Дамп данных таблицы `ckf_tax_rate`
--

INSERT INTO `ckf_tax_rate` (`tax_rate_id`, `geo_zone_id`, `name`, `rate`, `type`, `date_added`, `date_modified`) VALUES
...
--
-- Структура таблицы `ckf_tax_rate_to_customer_group`
--

CREATE TABLE `ckf_tax_rate_to_customer_group` (
  `tax_rate_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Дамп данных таблицы `ckf_tax_rate_to_customer_group`
--

INSERT INTO `ckf_tax_rate_to_customer_group` (`tax_rate_id`, `customer_group_id`) VALUES
(86, 1),
(87, 1);
...
--
-- Структура таблицы `ckf_tax_rule`
--

CREATE TABLE `ckf_tax_rule` (
...
--
-- Дамп данных таблицы `ckf_tax_rule`
--

INSERT INTO `ckf_tax_rule` (`tax_rule_id`, `tax_class_id`, `tax_rate_id`, `based`, `priority`) VALUES
(121, 10, 86, 'payment', 1),
(120, 10, 87, 'store', 0),
(128, 9, 86, 'shipping', 1),
(127, 9, 87, 'shipping', 2);
...
--
-- Структура таблицы `ckf_theme`
--

CREATE TABLE `ckf_theme` (
...
--
-- Структура таблицы `ckf_translation`
--

CREATE TABLE `ckf_translation` (
...
--
-- Структура таблицы `ckf_upload`
--

CREATE TABLE `ckf_upload` (
...
--
-- Структура таблицы `ckf_user`
--

CREATE TABLE `ckf_user` (
...
--
-- Дамп данных таблицы `ckf_user`
--

INSERT INTO `ckf_user` (`user_id`, `user_group_id`, `username`, `password`, `salt`, `firstname`, `lastname`, `email`, `image`, `code`, `ip`, `status`, `date_added`) VALUES
(1, 1, 'admin', 'f4ce44ca13b10546466d3b2ff2fb1e1c7d1bd7dd', 'iRnAS1w2j', 'John', 'Doe', 'sickmadweb@gmail.com', '', '', '', 1, '2020-12-20 17:47:04');

-- --------------------------------------------------------

--
-- Структура таблицы `ckf_user_group`
--

CREATE TABLE `ckf_user_group` (
  `user_group_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL,
...
--
-- Дамп данных таблицы `ckf_user_group`
--

INSERT INTO `ckf_user_group` (`user_group_id`, `name`, `permission`) VALUES
...
--
-- Структура таблицы `ckf_voucher`
--

CREATE TABLE `ckf_voucher` (
  `voucher_id` int(11) NOT NULL,
  `order_id` int(11) NOT NULL,
  `code` varchar(10) NOT NULL,
  `from_name` varchar(64) NOT NULL,
...
--
-- Структура таблицы `ckf_voucher_history`
--

CREATE TABLE `ckf_voucher_history` (
...
--
-- Структура таблицы `ckf_voucher_theme`
--

CREATE TABLE `ckf_voucher_theme` (
  `voucher_theme_id` int(11) NOT NULL,
  `image` varchar(255) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Дамп данных таблицы `ckf_voucher_theme`
--

INSERT INTO `ckf_voucher_theme` (`voucher_theme_id`, `image`) VALUES
...
--
-- Структура таблицы `ckf_voucher_theme_description`
--

CREATE TABLE `ckf_voucher_theme_description` (
  `voucher_theme_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(32) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Дамп данных таблицы `ckf_voucher_theme_description`
--

INSERT INTO `ckf_voucher_theme_description` (`voucher_theme_id`, `language_id`, `name`) VALUES
(6, 1, 'Christmas'),
(7, 1, 'Birthday'),
(8, 1, 'General');
...
--
-- Структура таблицы `ckf_weight_class`
--

CREATE TABLE `ckf_weight_class` (
  `weight_class_id` int(11) NOT NULL,
  `value` decimal(15,8) NOT NULL DEFAULT 0.00000000
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Дамп данных таблицы `ckf_weight_class`
--

INSERT INTO `ckf_weight_class` (`weight_class_id`, `value`) VALUES
(1, '1.00000000'),
(2, '1000.00000000'),
(5, '2.20460000'),
(6, '35.27400000');
...
--
-- Структура таблицы `ckf_weight_class_description`
--

CREATE TABLE `ckf_weight_class_description` (
  `weight_class_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `title` varchar(32) NOT NULL,
  `unit` varchar(4) NOT NULL
...
--
-- Дамп данных таблицы `ckf_weight_class_description`
--

INSERT INTO `ckf_weight_class_description` (`weight_class_id`, `language_id`, `title`, `unit`) VALUES
(1, 1, 'Килограммы', 'кг'),
(1, 2, 'Kilogram', 'kg'),
(2, 1, 'Граммы', 'г'),
(2, 2, 'Gram', 'g'),
...
--
-- Структура таблицы `ckf_zone`
--

CREATE TABLE `ckf_zone` (
...
--
-- Дамп данных таблицы `ckf_zone`
--

INSERT INTO `ckf_zone` (`zone_id`, `country_id`, `name`, `code`, `status`) VALUES
...
--
-- Структура таблицы `ckf_zone_to_geo_zone`
--

CREATE TABLE `ckf_zone_to_geo_zone` (
...
--
-- Дамп данных таблицы `ckf_zone_to_geo_zone`
--

INSERT INTO `ckf_zone_to_geo_zone` (`zone_to_geo_zone_id`, `country_id`, `zone_id`, `geo_zone_id`, `date_added`, `date_modified`) VALUES
...
--
-- Индексы таблицы `ckf_address`
--
ALTER TABLE `ckf_address`
  ADD PRIMARY KEY (`address_id`),
  ADD KEY `customer_id` (`customer_id`);

--
-- Индексы таблицы `ckf_api`
--
ALTER TABLE `ckf_api`
  ADD PRIMARY KEY (`api_id`);

--
-- Индексы таблицы `ckf_api_ip`
--
ALTER TABLE `ckf_api_ip`
  ADD PRIMARY KEY (`api_ip_id`);

--
-- Индексы таблицы `ckf_api_session`
--
ALTER TABLE `ckf_api_session`
  ADD PRIMARY KEY (`api_session_id`);

--
-- Индексы таблицы `ckf_article`
--
ALTER TABLE `ckf_article`
  ADD PRIMARY KEY (`article_id`);

--
-- Индексы таблицы `ckf_article_description`
--
ALTER TABLE `ckf_article_description`
  ADD PRIMARY KEY (`article_id`,`language_id`),
  ADD KEY `name` (`name`);

--
-- Индексы таблицы `ckf_article_image`
--
ALTER TABLE `ckf_article_image`
  ADD PRIMARY KEY (`article_image_id`);

--
-- Индексы таблицы `ckf_article_related`
--
ALTER TABLE `ckf_article_related`
  ADD PRIMARY KEY (`article_id`,`related_id`);

--
-- Индексы таблицы `ckf_article_related_mn`
--
ALTER TABLE `ckf_article_related_mn`
  ADD PRIMARY KEY (`article_id`,`manufacturer_id`);

--
-- Индексы таблицы `ckf_article_related_product`
--
ALTER TABLE `ckf_article_related_product`
  ADD PRIMARY KEY (`article_id`,`product_id`);

--
-- Индексы таблицы `ckf_article_related_wb`
--
ALTER TABLE `ckf_article_related_wb`
  ADD PRIMARY KEY (`article_id`,`category_id`);

--
-- Индексы таблицы `ckf_article_to_blog_category`
--
ALTER TABLE `ckf_article_to_blog_category`
  ADD PRIMARY KEY (`article_id`,`blog_category_id`);

--
-- Индексы таблицы `ckf_article_to_download`
--
ALTER TABLE `ckf_article_to_download`
  ADD PRIMARY KEY (`article_id`,`download_id`);

--
-- Индексы таблицы `ckf_article_to_layout`
--
ALTER TABLE `ckf_article_to_layout`
  ADD PRIMARY KEY (`article_id`,`store_id`);

--
-- Индексы таблицы `ckf_article_to_store`
--
ALTER TABLE `ckf_article_to_store`
  ADD PRIMARY KEY (`article_id`,`store_id`);

--
-- Индексы таблицы `ckf_attribute`
--
ALTER TABLE `ckf_attribute`
  ADD PRIMARY KEY (`attribute_id`);

--
-- Индексы таблицы `ckf_attribute_description`
--
ALTER TABLE `ckf_attribute_description`
  ADD PRIMARY KEY (`attribute_id`,`language_id`);

--
-- Индексы таблицы `ckf_attribute_group`
--
ALTER TABLE `ckf_attribute_group`
  ADD PRIMARY KEY (`attribute_group_id`);

--
-- Индексы таблицы `ckf_attribute_group_description`
--
ALTER TABLE `ckf_attribute_group_description`
  ADD PRIMARY KEY (`attribute_group_id`,`language_id`);

--
-- Индексы таблицы `ckf_banner`
--
ALTER TABLE `ckf_banner`
  ADD PRIMARY KEY (`banner_id`);

--
-- Индексы таблицы `ckf_banner_image`
--
ALTER TABLE `ckf_banner_image`
  ADD PRIMARY KEY (`banner_image_id`);

--
-- Индексы таблицы `ckf_blog_category`
--
ALTER TABLE `ckf_blog_category`
  ADD PRIMARY KEY (`blog_category_id`);

--
-- Индексы таблицы `ckf_blog_category_description`
--
ALTER TABLE `ckf_blog_category_description`
  ADD PRIMARY KEY (`blog_category_id`,`language_id`),
  ADD KEY `name` (`name`);

--
-- Индексы таблицы `ckf_blog_category_path`
--
ALTER TABLE `ckf_blog_category_path`
  ADD PRIMARY KEY (`blog_category_id`,`path_id`);

--
-- Индексы таблицы `ckf_blog_category_to_layout`
--
ALTER TABLE `ckf_blog_category_to_layout`
  ADD PRIMARY KEY (`blog_category_id`,`store_id`);

--
-- Индексы таблицы `ckf_blog_category_to_store`
--
ALTER TABLE `ckf_blog_category_to_store`
  ADD PRIMARY KEY (`blog_category_id`,`store_id`);

--
-- Индексы таблицы `ckf_cart`
--
ALTER TABLE `ckf_cart`
  ADD PRIMARY KEY (`cart_id`),
  ADD KEY `cart_id` (`api_id`,`customer_id`,`session_id`,`product_id`,`recurring_id`);

--
-- Индексы таблицы `ckf_category`
--
ALTER TABLE `ckf_category`
  ADD PRIMARY KEY (`category_id`),
  ADD KEY `parent_id` (`parent_id`);

--
-- Индексы таблицы `ckf_category_description`
--
ALTER TABLE `ckf_category_description`
  ADD PRIMARY KEY (`category_id`,`language_id`),
  ADD KEY `name` (`name`);

--
-- Индексы таблицы `ckf_category_filter`
--
ALTER TABLE `ckf_category_filter`
  ADD PRIMARY KEY (`category_id`,`filter_id`);

--
-- Индексы таблицы `ckf_category_path`
--
ALTER TABLE `ckf_category_path`
  ADD PRIMARY KEY (`category_id`,`path_id`);

--
-- Индексы таблицы `ckf_category_to_layout`
--
ALTER TABLE `ckf_category_to_layout`
  ADD PRIMARY KEY (`category_id`,`store_id`);

--
-- Индексы таблицы `ckf_category_to_store`
--
ALTER TABLE `ckf_category_to_store`
  ADD PRIMARY KEY (`category_id`,`store_id`);

--
-- Индексы таблицы `ckf_country`
--
ALTER TABLE `ckf_country`
  ADD PRIMARY KEY (`country_id`);

--
-- Индексы таблицы `ckf_coupon`
--
ALTER TABLE `ckf_coupon`
  ADD PRIMARY KEY (`coupon_id`);

--
-- Индексы таблицы `ckf_coupon_category`
--
ALTER TABLE `ckf_coupon_category`
  ADD PRIMARY KEY (`coupon_id`,`category_id`);

--
-- Индексы таблицы `ckf_coupon_history`
--
ALTER TABLE `ckf_coupon_history`
  ADD PRIMARY KEY (`coupon_history_id`);

--
-- Индексы таблицы `ckf_coupon_product`
--
ALTER TABLE `ckf_coupon_product`
  ADD PRIMARY KEY (`coupon_product_id`);

--
-- Индексы таблицы `ckf_currency`
--
ALTER TABLE `ckf_currency`
  ADD PRIMARY KEY (`currency_id`);

--
-- Индексы таблицы `ckf_customer`
--
ALTER TABLE `ckf_customer`
  ADD PRIMARY KEY (`customer_id`);

--
-- Индексы таблицы `ckf_customer_activity`
--
ALTER TABLE `ckf_customer_activity`
  ADD PRIMARY KEY (`customer_activity_id`);

--
-- Индексы таблицы `ckf_customer_affiliate`
--
ALTER TABLE `ckf_customer_affiliate`
  ADD PRIMARY KEY (`customer_id`);

--
-- Индексы таблицы `ckf_customer_approval`
--
ALTER TABLE `ckf_customer_approval`
  ADD PRIMARY KEY (`customer_approval_id`);

--
-- Индексы таблицы `ckf_customer_group`
--
ALTER TABLE `ckf_customer_group`
  ADD PRIMARY KEY (`customer_group_id`);

--
-- Индексы таблицы `ckf_customer_group_description`
--
ALTER TABLE `ckf_customer_group_description`
  ADD PRIMARY KEY (`customer_group_id`,`language_id`);

--
-- Индексы таблицы `ckf_customer_history`
--
ALTER TABLE `ckf_customer_history`
  ADD PRIMARY KEY (`customer_history_id`);

--
-- Индексы таблицы `ckf_customer_ip`
--
ALTER TABLE `ckf_customer_ip`
  ADD PRIMARY KEY (`customer_ip_id`),
  ADD KEY `ip` (`ip`);

--
-- Индексы таблицы `ckf_customer_login`
--
ALTER TABLE `ckf_customer_login`
  ADD PRIMARY KEY (`customer_login_id`),
  ADD KEY `email` (`email`),
  ADD KEY `ip` (`ip`);

--
-- Индексы таблицы `ckf_customer_online`
--
ALTER TABLE `ckf_customer_online`
  ADD PRIMARY KEY (`ip`);

--
-- Индексы таблицы `ckf_customer_reward`
--
ALTER TABLE `ckf_customer_reward`
  ADD PRIMARY KEY (`customer_reward_id`);

--
-- Индексы таблицы `ckf_customer_search`
--
ALTER TABLE `ckf_customer_search`
  ADD PRIMARY KEY (`customer_search_id`);

--
-- Индексы таблицы `ckf_customer_transaction`
--
ALTER TABLE `ckf_customer_transaction`
  ADD PRIMARY KEY (`customer_transaction_id`);

--
-- Индексы таблицы `ckf_customer_wishlist`
--
ALTER TABLE `ckf_customer_wishlist`
  ADD PRIMARY KEY (`customer_id`,`product_id`);

--
-- Индексы таблицы `ckf_custom_field`
--
ALTER TABLE `ckf_custom_field`
  ADD PRIMARY KEY (`custom_field_id`);

--
-- Индексы таблицы `ckf_custom_field_customer_group`
--
ALTER TABLE `ckf_custom_field_customer_group`
  ADD PRIMARY KEY (`custom_field_id`,`customer_group_id`);

--
-- Индексы таблицы `ckf_custom_field_description`
--
ALTER TABLE `ckf_custom_field_description`
  ADD PRIMARY KEY (`custom_field_id`,`language_id`);

--
-- Индексы таблицы `ckf_custom_field_value`
--
ALTER TABLE `ckf_custom_field_value`
  ADD PRIMARY KEY (`custom_field_value_id`);

--
-- Индексы таблицы `ckf_custom_field_value_description`
--
ALTER TABLE `ckf_custom_field_value_description`
  ADD PRIMARY KEY (`custom_field_value_id`,`language_id`);

--
-- Индексы таблицы `ckf_download`
--
ALTER TABLE `ckf_download`
  ADD PRIMARY KEY (`download_id`);

--
-- Индексы таблицы `ckf_download_description`
--
ALTER TABLE `ckf_download_description`
  ADD PRIMARY KEY (`download_id`,`language_id`);

--
-- Индексы таблицы `ckf_event`
--
ALTER TABLE `ckf_event`
  ADD PRIMARY KEY (`event_id`);

--
-- Индексы таблицы `ckf_extension`
--
ALTER TABLE `ckf_extension`
  ADD PRIMARY KEY (`extension_id`);

--
-- Индексы таблицы `ckf_extension_install`
--
ALTER TABLE `ckf_extension_install`
  ADD PRIMARY KEY (`extension_install_id`);

--
-- Индексы таблицы `ckf_extension_path`
--
ALTER TABLE `ckf_extension_path`
  ADD PRIMARY KEY (`extension_path_id`);

--
-- Индексы таблицы `ckf_filter`
--
ALTER TABLE `ckf_filter`
  ADD PRIMARY KEY (`filter_id`);

--
-- Индексы таблицы `ckf_filter_description`
--
ALTER TABLE `ckf_filter_description`
  ADD PRIMARY KEY (`filter_id`,`language_id`);

--
-- Индексы таблицы `ckf_filter_group`
--
ALTER TABLE `ckf_filter_group`
  ADD PRIMARY KEY (`filter_group_id`);

--
-- Индексы таблицы `ckf_filter_group_description`
--
ALTER TABLE `ckf_filter_group_description`
  ADD PRIMARY KEY (`filter_group_id`,`language_id`);

--
-- Индексы таблицы `ckf_geo_zone`
--
ALTER TABLE `ckf_geo_zone`
  ADD PRIMARY KEY (`geo_zone_id`);

--
-- Индексы таблицы `ckf_information`
--
ALTER TABLE `ckf_information`
  ADD PRIMARY KEY (`information_id`);

--
-- Индексы таблицы `ckf_information_description`
--
ALTER TABLE `ckf_information_description`
  ADD PRIMARY KEY (`information_id`,`language_id`);

--
-- Индексы таблицы `ckf_information_to_layout`
--
ALTER TABLE `ckf_information_to_layout`
  ADD PRIMARY KEY (`information_id`,`store_id`);

--
-- Индексы таблицы `ckf_information_to_store`
--
ALTER TABLE `ckf_information_to_store`
  ADD PRIMARY KEY (`information_id`,`store_id`);

--
-- Индексы таблицы `ckf_language`
--
ALTER TABLE `ckf_language`
  ADD PRIMARY KEY (`language_id`),
  ADD KEY `name` (`name`);

--
-- Индексы таблицы `ckf_layout`
--
ALTER TABLE `ckf_layout`
  ADD PRIMARY KEY (`layout_id`);

--
-- Индексы таблицы `ckf_layout_module`
--
ALTER TABLE `ckf_layout_module`
  ADD PRIMARY KEY (`layout_module_id`);

--
-- Индексы таблицы `ckf_layout_route`
--
ALTER TABLE `ckf_layout_route`
  ADD PRIMARY KEY (`layout_route_id`);

--
-- Индексы таблицы `ckf_length_class`
--
ALTER TABLE `ckf_length_class`
  ADD PRIMARY KEY (`length_class_id`);

--
-- Индексы таблицы `ckf_length_class_description`
--
ALTER TABLE `ckf_length_class_description`
  ADD PRIMARY KEY (`length_class_id`,`language_id`);

--
-- Индексы таблицы `ckf_location`
--
ALTER TABLE `ckf_location`
  ADD PRIMARY KEY (`location_id`),
  ADD KEY `name` (`name`);

--
-- Индексы таблицы `ckf_manufacturer`
--
ALTER TABLE `ckf_manufacturer`
  ADD PRIMARY KEY (`manufacturer_id`);

--
-- Индексы таблицы `ckf_manufacturer_to_layout`
--
ALTER TABLE `ckf_manufacturer_to_layout`
  ADD PRIMARY KEY (`manufacturer_id`,`store_id`);

--
-- Индексы таблицы `ckf_manufacturer_to_store`
--
ALTER TABLE `ckf_manufacturer_to_store`
  ADD PRIMARY KEY (`manufacturer_id`,`store_id`);

--
-- Индексы таблицы `ckf_marketing`
--
ALTER TABLE `ckf_marketing`
  ADD PRIMARY KEY (`marketing_id`);

--
-- Индексы таблицы `ckf_modification`
--
ALTER TABLE `ckf_modification`
  ADD PRIMARY KEY (`modification_id`);

--
-- Индексы таблицы `ckf_module`
--
ALTER TABLE `ckf_module`
  ADD PRIMARY KEY (`module_id`);

--
-- Индексы таблицы `ckf_option`
--
ALTER TABLE `ckf_option`
  ADD PRIMARY KEY (`option_id`);

--
-- Индексы таблицы `ckf_option_description`
--
ALTER TABLE `ckf_option_description`
  ADD PRIMARY KEY (`option_id`,`language_id`);

--
-- Индексы таблицы `ckf_option_value`
--
ALTER TABLE `ckf_option_value`
  ADD PRIMARY KEY (`option_value_id`);

--
-- Индексы таблицы `ckf_option_value_description`
--
ALTER TABLE `ckf_option_value_description`
  ADD PRIMARY KEY (`option_value_id`,`language_id`);

--
-- Индексы таблицы `ckf_order`
--
ALTER TABLE `ckf_order`
  ADD PRIMARY KEY (`order_id`);

--
-- Индексы таблицы `ckf_order_history`
--
ALTER TABLE `ckf_order_history`
  ADD PRIMARY KEY (`order_history_id`);

--
-- Индексы таблицы `ckf_order_option`
--
ALTER TABLE `ckf_order_option`
  ADD PRIMARY KEY (`order_option_id`);

--
-- Индексы таблицы `ckf_order_product`
--
ALTER TABLE `ckf_order_product`
  ADD PRIMARY KEY (`order_product_id`),
  ADD KEY `order_id` (`order_id`);

--
-- Индексы таблицы `ckf_order_recurring`
--
ALTER TABLE `ckf_order_recurring`
  ADD PRIMARY KEY (`order_recurring_id`);

--
-- Индексы таблицы `ckf_order_recurring_transaction`
--
ALTER TABLE `ckf_order_recurring_transaction`
  ADD PRIMARY KEY (`order_recurring_transaction_id`);

--
-- Индексы таблицы `ckf_order_shipment`
--
ALTER TABLE `ckf_order_shipment`
  ADD PRIMARY KEY (`order_shipment_id`);

--
-- Индексы таблицы `ckf_order_status`
--
ALTER TABLE `ckf_order_status`
  ADD PRIMARY KEY (`order_status_id`,`language_id`);

--
-- Индексы таблицы `ckf_order_total`
--
ALTER TABLE `ckf_order_total`
  ADD PRIMARY KEY (`order_total_id`),
  ADD KEY `order_id` (`order_id`);

--
-- Индексы таблицы `ckf_order_voucher`
--
ALTER TABLE `ckf_order_voucher`
  ADD PRIMARY KEY (`order_voucher_id`);

--
-- Индексы таблицы `ckf_product`
--
ALTER TABLE `ckf_product`
  ADD PRIMARY KEY (`product_id`);

--
-- Индексы таблицы `ckf_product_attribute`
--
ALTER TABLE `ckf_product_attribute`
  ADD PRIMARY KEY (`product_id`,`attribute_id`,`language_id`);

--
-- Индексы таблицы `ckf_product_description`
--
ALTER TABLE `ckf_product_description`
  ADD PRIMARY KEY (`product_id`,`language_id`),
  ADD KEY `name` (`name`);

--
-- Индексы таблицы `ckf_product_discount`
--
ALTER TABLE `ckf_product_discount`
  ADD PRIMARY KEY (`product_discount_id`),
  ADD KEY `product_id` (`product_id`);

--
-- Индексы таблицы `ckf_product_filter`
--
ALTER TABLE `ckf_product_filter`
  ADD PRIMARY KEY (`product_id`,`filter_id`);

--
-- Индексы таблицы `ckf_product_image`
--
ALTER TABLE `ckf_product_image`
  ADD PRIMARY KEY (`product_image_id`),
  ADD KEY `product_id` (`product_id`);

--
-- Индексы таблицы `ckf_product_option`
--
ALTER TABLE `ckf_product_option`
  ADD PRIMARY KEY (`product_option_id`);

--
-- Индексы таблицы `ckf_product_option_value`
--
ALTER TABLE `ckf_product_option_value`
  ADD PRIMARY KEY (`product_option_value_id`);

--
-- Индексы таблицы `ckf_product_recurring`
--
ALTER TABLE `ckf_product_recurring`
  ADD PRIMARY KEY (`product_id`,`recurring_id`,`customer_group_id`);

--
-- Индексы таблицы `ckf_product_related`
--
ALTER TABLE `ckf_product_related`
  ADD PRIMARY KEY (`product_id`,`related_id`);

--
-- Индексы таблицы `ckf_product_related_article`
--
ALTER TABLE `ckf_product_related_article`
  ADD PRIMARY KEY (`article_id`,`product_id`);

--
-- Индексы таблицы `ckf_product_reward`
--
ALTER TABLE `ckf_product_reward`
  ADD PRIMARY KEY (`product_reward_id`);

--
-- Индексы таблицы `ckf_product_special`
--
ALTER TABLE `ckf_product_special`
  ADD PRIMARY KEY (`product_special_id`),
  ADD KEY `product_id` (`product_id`);

--
-- Индексы таблицы `ckf_product_to_category`
--
ALTER TABLE `ckf_product_to_category`
  ADD PRIMARY KEY (`product_id`,`category_id`),
  ADD KEY `category_id` (`category_id`);

--
-- Индексы таблицы `ckf_product_to_download`
--
ALTER TABLE `ckf_product_to_download`
  ADD PRIMARY KEY (`product_id`,`download_id`);

--
-- Индексы таблицы `ckf_product_to_layout`
--
ALTER TABLE `ckf_product_to_layout`
  ADD PRIMARY KEY (`product_id`,`store_id`);

--
-- Индексы таблицы `ckf_product_to_store`
--
ALTER TABLE `ckf_product_to_store`
  ADD PRIMARY KEY (`product_id`,`store_id`);

--
-- Индексы таблицы `ckf_recurring`
--
ALTER TABLE `ckf_recurring`
  ADD PRIMARY KEY (`recurring_id`);

--
-- Индексы таблицы `ckf_recurring_description`
--
ALTER TABLE `ckf_recurring_description`
  ADD PRIMARY KEY (`recurring_id`,`language_id`);

--
-- Индексы таблицы `ckf_return`
--
ALTER TABLE `ckf_return`
  ADD PRIMARY KEY (`return_id`);

--
-- Индексы таблицы `ckf_return_action`
--
ALTER TABLE `ckf_return_action`
  ADD PRIMARY KEY (`return_action_id`,`language_id`);

--
-- Индексы таблицы `ckf_return_history`
--
ALTER TABLE `ckf_return_history`
  ADD PRIMARY KEY (`return_history_id`);

--
-- Индексы таблицы `ckf_return_reason`
--
ALTER TABLE `ckf_return_reason`
  ADD PRIMARY KEY (`return_reason_id`,`language_id`);

--
-- Индексы таблицы `ckf_return_status`
--
ALTER TABLE `ckf_return_status`
  ADD PRIMARY KEY (`return_status_id`,`language_id`);

--
-- Индексы таблицы `ckf_review`
--
ALTER TABLE `ckf_review`
  ADD PRIMARY KEY (`review_id`),
  ADD KEY `product_id` (`product_id`);

--
-- Индексы таблицы `ckf_review_article`
--
ALTER TABLE `ckf_review_article`
  ADD PRIMARY KEY (`review_article_id`),
  ADD KEY `article_id` (`article_id`);

--
-- Индексы таблицы `ckf_seo_url`
--
ALTER TABLE `ckf_seo_url`
  ADD PRIMARY KEY (`seo_url_id`),
  ADD KEY `query` (`query`),
  ADD KEY `keyword` (`keyword`);

--
-- Индексы таблицы `ckf_session`
--
ALTER TABLE `ckf_session`
  ADD PRIMARY KEY (`session_id`);

--
-- Индексы таблицы `ckf_setting`
--
ALTER TABLE `ckf_setting`
  ADD PRIMARY KEY (`setting_id`);

--
-- Индексы таблицы `ckf_shipping_courier`
--
ALTER TABLE `ckf_shipping_courier`
  ADD PRIMARY KEY (`shipping_courier_id`);

--
-- Индексы таблицы `ckf_statistics`
--
ALTER TABLE `ckf_statistics`
  ADD PRIMARY KEY (`statistics_id`);

--
-- Индексы таблицы `ckf_stock_status`
--
ALTER TABLE `ckf_stock_status`
  ADD PRIMARY KEY (`stock_status_id`,`language_id`);

--
-- Индексы таблицы `ckf_store`
--
ALTER TABLE `ckf_store`
  ADD PRIMARY KEY (`store_id`);

--
-- Индексы таблицы `ckf_tax_class`
--
ALTER TABLE `ckf_tax_class`
  ADD PRIMARY KEY (`tax_class_id`);

--
-- Индексы таблицы `ckf_tax_rate`
--
ALTER TABLE `ckf_tax_rate`
  ADD PRIMARY KEY (`tax_rate_id`);

--
-- Индексы таблицы `ckf_tax_rate_to_customer_group`
--
ALTER TABLE `ckf_tax_rate_to_customer_group`
  ADD PRIMARY KEY (`tax_rate_id`,`customer_group_id`);

--
-- Индексы таблицы `ckf_tax_rule`
--
ALTER TABLE `ckf_tax_rule`
  ADD PRIMARY KEY (`tax_rule_id`);

--
-- Индексы таблицы `ckf_theme`
--
ALTER TABLE `ckf_theme`
  ADD PRIMARY KEY (`theme_id`);

--
-- Индексы таблицы `ckf_translation`
--
ALTER TABLE `ckf_translation`
  ADD PRIMARY KEY (`translation_id`);

--
-- Индексы таблицы `ckf_upload`
--
ALTER TABLE `ckf_upload`
  ADD PRIMARY KEY (`upload_id`);

--
-- Индексы таблицы `ckf_user`
--
ALTER TABLE `ckf_user`
  ADD PRIMARY KEY (`user_id`);

--
-- Индексы таблицы `ckf_user_group`
--
ALTER TABLE `ckf_user_group`
  ADD PRIMARY KEY (`user_group_id`);

--
-- Индексы таблицы `ckf_voucher`
--
ALTER TABLE `ckf_voucher`
  ADD PRIMARY KEY (`voucher_id`);

--
-- Индексы таблицы `ckf_voucher_history`
--
ALTER TABLE `ckf_voucher_history`
  ADD PRIMARY KEY (`voucher_history_id`);

--
-- Индексы таблицы `ckf_voucher_theme`
--
ALTER TABLE `ckf_voucher_theme`
  ADD PRIMARY KEY (`voucher_theme_id`);

--
-- Индексы таблицы `ckf_voucher_theme_description`
--
ALTER TABLE `ckf_voucher_theme_description`
  ADD PRIMARY KEY (`voucher_theme_id`,`language_id`);

--
-- Индексы таблицы `ckf_weight_class`
--
ALTER TABLE `ckf_weight_class`
  ADD PRIMARY KEY (`weight_class_id`);

--
-- Индексы таблицы `ckf_weight_class_description`
--
ALTER TABLE `ckf_weight_class_description`
  ADD PRIMARY KEY (`weight_class_id`,`language_id`);

--
-- Индексы таблицы `ckf_zone`
--
ALTER TABLE `ckf_zone`
  ADD PRIMARY KEY (`zone_id`);

--
-- Индексы таблицы `ckf_zone_to_geo_zone`
--
ALTER TABLE `ckf_zone_to_geo_zone`
...
--
-- AUTO_INCREMENT для таблицы `ckf_address`
--
ALTER TABLE `ckf_address`
  MODIFY `address_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_api`
--
ALTER TABLE `ckf_api`
  MODIFY `api_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT для таблицы `ckf_api_ip`
--
ALTER TABLE `ckf_api_ip`
  MODIFY `api_ip_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_api_session`
--
ALTER TABLE `ckf_api_session`
  MODIFY `api_session_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_article`
--
ALTER TABLE `ckf_article`
  MODIFY `article_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=126;

--
-- AUTO_INCREMENT для таблицы `ckf_article_image`
--
ALTER TABLE `ckf_article_image`
  MODIFY `article_image_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3981;

--
-- AUTO_INCREMENT для таблицы `ckf_attribute`
--
ALTER TABLE `ckf_attribute`
  MODIFY `attribute_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT для таблицы `ckf_attribute_group`
--
ALTER TABLE `ckf_attribute_group`
  MODIFY `attribute_group_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT для таблицы `ckf_banner`
--
ALTER TABLE `ckf_banner`
  MODIFY `banner_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT для таблицы `ckf_banner_image`
--
ALTER TABLE `ckf_banner_image`
  MODIFY `banner_image_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=127;

--
-- AUTO_INCREMENT для таблицы `ckf_blog_category`
--
ALTER TABLE `ckf_blog_category`
  MODIFY `blog_category_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;

--
-- AUTO_INCREMENT для таблицы `ckf_cart`
--
ALTER TABLE `ckf_cart`
  MODIFY `cart_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_category`
--
ALTER TABLE `ckf_category`
  MODIFY `category_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;

--
-- AUTO_INCREMENT для таблицы `ckf_country`
--
ALTER TABLE `ckf_country`
  MODIFY `country_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=258;

--
-- AUTO_INCREMENT для таблицы `ckf_coupon`
--
ALTER TABLE `ckf_coupon`
  MODIFY `coupon_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT для таблицы `ckf_coupon_history`
--
ALTER TABLE `ckf_coupon_history`
  MODIFY `coupon_history_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_coupon_product`
--
ALTER TABLE `ckf_coupon_product`
  MODIFY `coupon_product_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_currency`
--
ALTER TABLE `ckf_currency`
  MODIFY `currency_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT для таблицы `ckf_customer`
--
ALTER TABLE `ckf_customer`
  MODIFY `customer_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_customer_activity`
--
ALTER TABLE `ckf_customer_activity`
  MODIFY `customer_activity_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_customer_approval`
--
ALTER TABLE `ckf_customer_approval`
  MODIFY `customer_approval_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_customer_group`
--
ALTER TABLE `ckf_customer_group`
  MODIFY `customer_group_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT для таблицы `ckf_customer_history`
--
ALTER TABLE `ckf_customer_history`
  MODIFY `customer_history_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_customer_ip`
--
ALTER TABLE `ckf_customer_ip`
  MODIFY `customer_ip_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_customer_login`
--
ALTER TABLE `ckf_customer_login`
  MODIFY `customer_login_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_customer_reward`
--
ALTER TABLE `ckf_customer_reward`
  MODIFY `customer_reward_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_customer_search`
--
ALTER TABLE `ckf_customer_search`
  MODIFY `customer_search_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_customer_transaction`
--
ALTER TABLE `ckf_customer_transaction`
  MODIFY `customer_transaction_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_custom_field`
--
ALTER TABLE `ckf_custom_field`
  MODIFY `custom_field_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_custom_field_value`
--
ALTER TABLE `ckf_custom_field_value`
  MODIFY `custom_field_value_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_download`
--
ALTER TABLE `ckf_download`
  MODIFY `download_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_event`
--
ALTER TABLE `ckf_event`
  MODIFY `event_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT для таблицы `ckf_extension`
--
ALTER TABLE `ckf_extension`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;

--
-- AUTO_INCREMENT для таблицы `ckf_extension_install`
--
ALTER TABLE `ckf_extension_install`
  MODIFY `extension_install_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_extension_path`
--
ALTER TABLE `ckf_extension_path`
  MODIFY `extension_path_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_filter`
--
ALTER TABLE `ckf_filter`
  MODIFY `filter_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_filter_group`
--
ALTER TABLE `ckf_filter_group`
  MODIFY `filter_group_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_geo_zone`
--
ALTER TABLE `ckf_geo_zone`
  MODIFY `geo_zone_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT для таблицы `ckf_information`
--
ALTER TABLE `ckf_information`
  MODIFY `information_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT для таблицы `ckf_language`
--
ALTER TABLE `ckf_language`
  MODIFY `language_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT для таблицы `ckf_layout`
--
ALTER TABLE `ckf_layout`
  MODIFY `layout_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT для таблицы `ckf_layout_module`
--
ALTER TABLE `ckf_layout_module`
  MODIFY `layout_module_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=89;

--
-- AUTO_INCREMENT для таблицы `ckf_layout_route`
--
ALTER TABLE `ckf_layout_route`
  MODIFY `layout_route_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;

--
-- AUTO_INCREMENT для таблицы `ckf_length_class`
--
ALTER TABLE `ckf_length_class`
  MODIFY `length_class_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT для таблицы `ckf_location`
--
ALTER TABLE `ckf_location`
  MODIFY `location_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_manufacturer`
--
ALTER TABLE `ckf_manufacturer`
  MODIFY `manufacturer_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT для таблицы `ckf_marketing`
--
ALTER TABLE `ckf_marketing`
  MODIFY `marketing_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_modification`
--
ALTER TABLE `ckf_modification`
  MODIFY `modification_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_module`
--
ALTER TABLE `ckf_module`
  MODIFY `module_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT для таблицы `ckf_option`
--
ALTER TABLE `ckf_option`
  MODIFY `option_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT для таблицы `ckf_option_value`
--
ALTER TABLE `ckf_option_value`
  MODIFY `option_value_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;

--
-- AUTO_INCREMENT для таблицы `ckf_order`
--
ALTER TABLE `ckf_order`
  MODIFY `order_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_order_history`
--
ALTER TABLE `ckf_order_history`
  MODIFY `order_history_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_order_option`
--
ALTER TABLE `ckf_order_option`
  MODIFY `order_option_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_order_product`
--
ALTER TABLE `ckf_order_product`
  MODIFY `order_product_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_order_recurring`
--
ALTER TABLE `ckf_order_recurring`
  MODIFY `order_recurring_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_order_recurring_transaction`
--
ALTER TABLE `ckf_order_recurring_transaction`
  MODIFY `order_recurring_transaction_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_order_shipment`
--
ALTER TABLE `ckf_order_shipment`
  MODIFY `order_shipment_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_order_status`
--
ALTER TABLE `ckf_order_status`
  MODIFY `order_status_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT для таблицы `ckf_order_total`
--
ALTER TABLE `ckf_order_total`
  MODIFY `order_total_id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_order_voucher`
--
ALTER TABLE `ckf_order_voucher`
  MODIFY `order_voucher_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_product`
--
ALTER TABLE `ckf_product`
  MODIFY `product_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;

--
-- AUTO_INCREMENT для таблицы `ckf_product_discount`
--
ALTER TABLE `ckf_product_discount`
  MODIFY `product_discount_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=441;

--
-- AUTO_INCREMENT для таблицы `ckf_product_image`
--
ALTER TABLE `ckf_product_image`
  MODIFY `product_image_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2352;

--
-- AUTO_INCREMENT для таблицы `ckf_product_option`
--
ALTER TABLE `ckf_product_option`
  MODIFY `product_option_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=227;

--
-- AUTO_INCREMENT для таблицы `ckf_product_option_value`
--
ALTER TABLE `ckf_product_option_value`
  MODIFY `product_option_value_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT для таблицы `ckf_product_reward`
--
ALTER TABLE `ckf_product_reward`
  MODIFY `product_reward_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=546;

--
-- AUTO_INCREMENT для таблицы `ckf_product_special`
--
ALTER TABLE `ckf_product_special`
  MODIFY `product_special_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=440;

--
-- AUTO_INCREMENT для таблицы `ckf_recurring`
--
ALTER TABLE `ckf_recurring`
  MODIFY `recurring_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_return`
--
ALTER TABLE `ckf_return`
  MODIFY `return_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_return_action`
--
ALTER TABLE `ckf_return_action`
  MODIFY `return_action_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT для таблицы `ckf_return_history`
--
ALTER TABLE `ckf_return_history`
  MODIFY `return_history_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_return_reason`
--
ALTER TABLE `ckf_return_reason`
  MODIFY `return_reason_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT для таблицы `ckf_return_status`
--
ALTER TABLE `ckf_return_status`
  MODIFY `return_status_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT для таблицы `ckf_review`
--
ALTER TABLE `ckf_review`
  MODIFY `review_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_review_article`
--
ALTER TABLE `ckf_review_article`
  MODIFY `review_article_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT для таблицы `ckf_seo_url`
--
ALTER TABLE `ckf_seo_url`
  MODIFY `seo_url_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=984;

--
-- AUTO_INCREMENT для таблицы `ckf_setting`
--
ALTER TABLE `ckf_setting`
  MODIFY `setting_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=227;

--
-- AUTO_INCREMENT для таблицы `ckf_statistics`
--
ALTER TABLE `ckf_statistics`
  MODIFY `statistics_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT для таблицы `ckf_stock_status`
--
ALTER TABLE `ckf_stock_status`
  MODIFY `stock_status_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT для таблицы `ckf_store`
--
ALTER TABLE `ckf_store`
  MODIFY `store_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_tax_class`
--
ALTER TABLE `ckf_tax_class`
  MODIFY `tax_class_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT для таблицы `ckf_tax_rate`
--
ALTER TABLE `ckf_tax_rate`
  MODIFY `tax_rate_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=88;

--
-- AUTO_INCREMENT для таблицы `ckf_tax_rule`
--
ALTER TABLE `ckf_tax_rule`
  MODIFY `tax_rule_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=129;

--
-- AUTO_INCREMENT для таблицы `ckf_theme`
--
ALTER TABLE `ckf_theme`
  MODIFY `theme_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_translation`
--
ALTER TABLE `ckf_translation`
  MODIFY `translation_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_upload`
--
ALTER TABLE `ckf_upload`
  MODIFY `upload_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_user`
--
ALTER TABLE `ckf_user`
  MODIFY `user_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT для таблицы `ckf_user_group`
--
ALTER TABLE `ckf_user_group`
  MODIFY `user_group_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT для таблицы `ckf_voucher`
--
ALTER TABLE `ckf_voucher`
  MODIFY `voucher_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_voucher_history`
--
ALTER TABLE `ckf_voucher_history`
  MODIFY `voucher_history_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ckf_voucher_theme`
--
ALTER TABLE `ckf_voucher_theme`
  MODIFY `voucher_theme_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT для таблицы `ckf_weight_class`
--
ALTER TABLE `ckf_weight_class`
  MODIFY `weight_class_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT для таблицы `ckf_zone`
--
ALTER TABLE `ckf_zone`
  MODIFY `zone_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4232;

--
-- AUTO_INCREMENT для таблицы `ckf_zone_to_geo_zone`
--
ALTER TABLE `ckf_zone_to_geo_zone`
